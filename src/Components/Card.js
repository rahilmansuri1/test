...
const Card = ({ product }) => {
    return (
        <div className="max-w-md w-auto max-h-md mt-[10%] bg-gray-900 shadow-lg rounded-xl p-6">
            <div className="flex flex-col ">
                <div className=" h-62 w-full mb-3">
                    <div className="flex flex-col ml-[90%] top-0 right-0 p-3">
                    ...
                    <img src={product.imageURL} alt="Product image" className=" w-full object-fill rounded-2xl" />
                </div>
                <div className="flex-auto justify-evenly">
                    <div className="flex flex-wrap ">
                        <div className="w-full flex-none text-sm flex items-center text-gray-600">
                            ...
                            <span className="text-gray-400 whitespace-nowrap mr-3">{product.rating ? product.rating : 'No Ratings'}</span><span className="mr-2 text-gray-400">India</span>
                        </div>
                        <div className="flex flex-col items-center w-full justify-between min-w-0 ">
                            <h2 className="text-lg mr-auto cursor-pointer text-gray-200 hover:text-purple-500 truncate ">{product.name}</h2>
                            <h2 className="text-sm mr-auto cursor-pointer text-gray-200 hover:text-purple-500 truncate ">{product.desc}</h2>
                            <div className="flex ml-[50%]  items-center bg-green-400 text-white text-xs px-2 py-1 ml-3 rounded-lg">
                                INSTOCK</div>
                        </div>
                    </div>
